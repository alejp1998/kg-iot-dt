...
# Get-current graph
current_graph = get_full_graph()

variable_graph = nx.MultiDiGraph()
# Entities
variable_graph.add_node('company')
variable_graph.add_node('factory')
variable_graph.add_node('plant')
variable_graph.add_node('department')
variable_graph.add_node('service')
variable_graph.add_node('task')
variable_graph.add_node('device')
variable_graph.add_node('module')
# Relations
variable_graph.add_node('ownership')
variable_graph.add_edge('ownership', 'company', type='owner')
variable_graph.add_edge('ownership', 'factory', type='owned')
variable_graph.add_node('subdivision')
variable_graph.add_edge('subdivision', 'factory', type='parent')
variable_graph.add_edge('subdivision', 'plant', type='child')
variable_graph.add_node('departmentation')
variable_graph.add_edge('departmentation', 'plant', type='plant')
variable_graph.add_edge('departmentation', 'department', type='department')
variable_graph.add_node('provision')
variable_graph.add_edge('provision', 'department', type='department')
variable_graph.add_edge('provision', 'service', type='service')
variable_graph.add_node('execution')
variable_graph.add_edge('execution', 'department', type='department')
variable_graph.add_edge('execution', 'task', type='task')
variable_graph.add_node('fulfillment')
variable_graph.add_edge('fulfillment', 'service', type='department')
variable_graph.add_edge('fulfillment', 'task', type='task')
variable_graph.add_edge('fulfillment', 'device', type='device')
variable_graph.add_node('sequence')
variable_graph.add_edge('sequence', 'task', type='predecessor')
variable_graph.add_edge('sequence', 'task', type='successor')
variable_graph.add_edge('sequence', 'device', type='connectedby')
variable_graph.add_node('needs')
variable_graph.add_edge('needs', 'task', type='task')
variable_graph.add_edge('needs', 'device', type='device')
variable_graph.add_node('includes')
variable_graph.add_edge('includes', 'device', type='device')
variable_graph.add_edge('includes', 'module', type='module')

result = conceptdicttonx(current_graph,variable_graph)
print(result)
# Start KG operation
kg_agent.start()
...
initially described tasks in the simple car manufacturing plant.
These tasks are divided into the production and safety/environmental departments.
...
def main():
    ...
    # Indoors Monitoring
    indoors_airquality = AirQuality(
        safetyenv_indoors, devuuid="indoors_airquality", print_logs=True
    )
    indoors_airquality.start()
    NoiseSensor(devuuid="7fc17e8f-1e1c-43f8-a2d1-9ff4bcfbf9ff").start()
    SmokeSensor(devuuid="5a84f26b-bf77-42d3-ab8a-83a214112844").start()
    ...
    indoors_airquality.active = False  # stop indoors air quality
    time.sleep(15)
    indoors_airqualitymod = AirQualitySimplified(
        safetyenv_indoors, devuuid="indoors_airqualitysimp", print_logs=True
    )
    ...
    bodyconfig_pickuprob2 = PickUpRobot(
        prod_body_params, devuuid="bodyconfig_pickuprob2", print_logs=False
    )
